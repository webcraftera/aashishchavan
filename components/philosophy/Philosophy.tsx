...
export function Philosophy() {
  return (
    <section className="relative overflow-hidden py-32 sm:py-40">
      ...
      <div className="absolute left-1/2 top-1/2 h-[300px] w-[400px] max-w-[120vw] -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent/[0.04] blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <Reveal delay={0.1}>
          <h2 className="mt-6 font-display text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl lg:text-6xl xl:text-7xl">
            Build with purpose.
            <br />
        ...
        <Reveal delay={0.3}>
          <div className="mt-12 flex flex-wrap items-center justify-center gap-3">
            {["Quality", "Performance", "Usability", "Innovation"].map((value) => (
              <span
                key={value}
                className="rounded-full border border-accent/20 bg-accent-soft px-5 py-2 text-sm font-semibold text-accent backdrop-blur-sm transition-all hover:border-accent/40 hover:bg-accent/15"
              >
                {value}
              </span>
            ))}
